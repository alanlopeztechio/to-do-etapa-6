...
>
> - Visión de tecnologías usadas: [docs/TECH_STACK.md](docs/TECH_STACK.md)
> - Arquitectura y flujo de datos: [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md)
> - Setup y ejecución local: [docs/SETUP.md](docs/SETUP.md)
> - Notas y aprendizajes: [docs/LEARNINGS.md](docs/LEARNINGS.md)
> - Sanity Functions: [docs/SANITY_FUNCTIONS.md](docs/SANITY_FUNCTIONS.md)
> - Tareas y suscripciones: [docs/TASKS_AND_SUBSCRIPTIONS.md](docs/TASKS_AND_SUBSCRIPTIONS.md)
